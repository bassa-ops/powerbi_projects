...
from
(select count(distinct product_code) as unique_products, fiscal_year from fact_gross_price group by fiscal_year) as f1, 
(select count(distinct product_code) as unique_products, fiscal_year from fact_gross_price group by fiscal_year)as f2 
where f1.fiscal_year<f2.fiscal_year;
